...
function FCOCTB.BuildAddonMenu()
    ...
    local optionsTable =
    {
        ...
        ----- Guild 1---------------------------------------------------------------------------------------------------
        {
            ...
            disabled = function() return GetNumGuilds() >= 1 end,
            controls = {
                {
                    type = 'dropdown',
        ...
        ----- Guild 2---------------------------------------------------------------------------------------------------
        {
            ...
            disabled = function() return GetNumGuilds() >= 2 end,
            controls = {
                {
                    type = 'dropdown',
        ...
        ----- Guild 3---------------------------------------------------------------------------------------------------
        {
            ...
            disabled = function() return GetNumGuilds() >= 3 end,
            controls = {
                {
                    type = 'dropdown',
        ...
        ----- Guild 4---------------------------------------------------------------------------------------------------
        {
            ...
            disabled = function() return GetNumGuilds() >= 4 end,
            controls = {
                {
                    type = 'dropdown',
        ...
        ----- Guild 5---------------------------------------------------------------------------------------------------
        {
            ...
            disabled = function() return GetNumGuilds() >= 5 end,
            controls = {
                {
                    type = 'dropdown',
